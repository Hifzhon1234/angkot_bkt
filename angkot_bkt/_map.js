        var map;
        // var server = "http://localhost/iisi/angkot_bkt";
        var server = "http://13.76.160.55/angkot_bkt/angkot_bkt/";
        ...
        *********************************************************************************************************************************************************** */
        ...
        function data_angkot_1_info(id_angkots) { // ANGKOT - KLIK TOMBOL RUTE - DATA 1 ANGKOT
            ...
            $.ajax({
                url: server + '/tampilkanrute.php?id_angkot=' + id_angkots,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows.features) {
        ...
        *********************************************************************************************************************************************************** */
        ...
        function angkot_sekitar(latitude, longitude, rad) { // Menu Angkot - List Angkot
            ...
            $.ajax({
                url: server + '_sekitar_angkot.php?lat=' + latitude + '&long=' + longitude + '&rad=' + rad,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    if (rows == null) {
        ...
        *********************************************************************************************************************************************************** */
        ...
        function cari_angkot(tipe) { // PENCARIAN ANGKUTAN KOTA
            ...
            $.ajax({
                url: server + '_data_angkot_cari.php?tipe=' + tipe + '&nilai=' + y,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    if (rows == null) {
        ...
        *********************************************************************************************************************************************************** */
        ...
        function data_angkot_rute(id) { // ANGKOT - KLIK TOMBOL RUTE - DATA 1 ANGKOT
            hapus_kecuali_landmark();
            $.ajax({
                url: server + '/tampilkanrute.php?id_angkot=' + id,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows.features) {
        ...
        *********************************************************************************************************************************************************** */
        ...
        function industri_sekitar(latitude, longitude, rad) { // INDUSTRI SEKITAR
            ...
            $.ajax({
                url: server + '_sekitar_small_industry.php?lat=' + latitude + '&long=' + longitude + '&rad=' + rad,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
        ...
        function kuliner_sekitar(latitude, longitude, rad) { //KULINER SEKITAR ANGKOT
            ...
            $.ajax({
                url: server + '_sekitar_culinary_place.php?lat=' + latitude + '&long=' + longitude + '&rad=' + rad,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
        ...
        function masjid_sekitar(latitude, longitude, rad) { // MASJID SEKITAR ANGKOT
            ...
            $.ajax({
                url: server + '_sekitar_worship_place.php?lat=' + latitude + '&long=' + longitude + '&rad=' + rad,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
        ...
        function tw_sekitar(latitude, longitude, rad) { // TEMPAT WISATA SEKITAR ANGKOT
            ...
            $.ajax({
                url: server + '_sekitar_tourism.php?lat=' + latitude + '&long=' + longitude + '&rad=' + rad,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
        ...
        function terserah() { //FUNGSIONAL I (Alfarizi)
            var tipe = $('#tipe').val();
            var sasa = $('#sasa').val();
            console.log(server + 'yaya.php?tipe_hotel=' + tipe + '&marriage_book=' + sasa);
            hapus_kecuali_landmark();
            hapus_landmark();
            hapus_menu();
            hapus_Semua();
            ...
            $('#kanan_table').append("<tr><th class='centered'>Destination</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'yaya.php?tipe_hotel=' + tipe + '&marriage_book=' + sasa,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    if (rows == null) {
                    ...
                    for (var i in rows) {
                        ...
                        var color = row.color;
                        var route_color = row.route_color;
                        $('#kanan_table').append("<tr><td>" + destination + "</td><td><a role='button' class='btn btn-default fa fa-info' onclick='data_angkot_1_info(\"" + id + "\")'>&nbsp&nbsp&nbspInfo</a><a role='button' class='btn btn-default fa fa-info' onclick='tampil_hotel(\"" + id + "\")'>&nbsp&nbsp&nbspTampil</a><a style='margin-left:10px' role='button' class='btn btn-default fa fa-bus' onclick='data_angkot_1_rute(\"" + id + "\")'>Route</a></td></tr>");
        ...
        function terserah1() { //FUNGSIONAL I (Ica)
            var tipe = $('#tipe_mesjid').val();
            var kapasitas = $('#kapasitas').val();
            console.log(server + 'ica.php?tipe_mesjid=' + tipe + '&kapasitas=' + kapasitas);
            hapus_kecuali_landmark();
            hapus_landmark();
            hapus_menu();
            hapus_Semua();
            ...
            $('#kanan_table').append("<tr><th class='centered'>Destination</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'ica.php?tipe_mesjid=' + tipe + '&kapasitas=' + kapasitas,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    if (rows == null) {
                    ...
                    for (var i in rows) {
                        ...
                        var color = row.color;
                        var route_color = row.route_color;
                        $('#kanan_table').append("<tr><td>" + destination + "</td><td><a role='button' class='btn btn-default fa fa-info' onclick='data_angkot_1_info(\"" + id + "\")'>&nbsp&nbsp&nbspInfo</a><a role='button' class='btn btn-default fa fa-info' onclick='tampil_worship(\"" + id + "\")'>&nbsp&nbsp&nbspTampil</a><a style='margin-left:10px' role='button' class='btn btn-default fa fa-bus' onclick='data_angkot_1_rute(\"" + id + "\")'>Route</a></td></tr>");
                        //MAP
                        route_angkot_1(id, route_color);
                    } //end for               
                }
        ...
        function terserah2() { //FUNGSIONAL I (Alfarizi)
            var tipe = $('#tipe_souvenir').val();
            console.log(server + 'eci.php?tipe_souvenir=' + tipe);
            hapus_kecuali_landmark();
            hapus_landmark();
            hapus_menu();
            hapus_Semua();
            ...
            $('#kanan_table').append("<tr><th class='centered'>Destination</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'eci.php?tipe_souvenir=' + tipe,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    if (rows == null) {
                    ...
                    for (var i in rows) {
                        ...
                        var color = row.color;
                        var route_color = row.route_color;
                        $('#kanan_table').append("<tr><td>" + destination + "</td><td><a role='button' class='btn btn-default fa fa-info' onclick='data_angkot_1_info(\"" + id + "\")'>&nbsp&nbsp&nbspInfo</a><a role='button' class='btn btn-default fa fa-info' onclick='tampil_souvenir(\"" + id + "\")'>&nbsp&nbsp&nbspTampil</a><a style='margin-left:10px' role='button' class='btn btn-default fa fa-bus' onclick='data_angkot_1_rute(\"" + id + "\")'>Route</a></td></tr>");
        ...
        function terserah3() { //FUNGSIONAL I (culiner)
            var tipe = $('#tipe_kuliner').val();
            var kapasitas = $('#capacity').val();
            console.log(server + 'viki.php?tipe_kuliner=' + tipe + '&capacity=' + kapasitas);
            hapus_kecuali_landmark();
            hapus_landmark();
            hapus_menu();
            hapus_Semua();
            ...
            $('#kanan_table').append("<tr><th class='centered'>Destination</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'viki.php?tipe_kuliner=' + tipe + '&capacity=' + kapasitas,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    if (rows == null) {
                    ...
                    for (var i in rows) {
                        ...
                        var color = row.color;
                        var route_color = row.route_color;
                        $('#kanan_table').append("<tr><td>" + destination + "</td><td><a role='button' class='btn btn-default fa fa-info' onclick='data_angkot_1_info(\"" + id + "\")'>&nbsp&nbsp&nbspInfo</a><a role='button' class='btn btn-default fa fa-info' onclick='tampil_culiner(\"" + id + "\")'>&nbsp&nbsp&nbspTampil</a><a style='margin-left:10px' role='button' class='btn btn-default fa fa-bus' onclick='data_angkot_1_rute(\"" + id + "\")'>Route</a></td></tr>");
        ...
        function terserah4() { //FUNGSIONAL I (culiner)
            var tipe = $('#tipe_wisata').val();
            console.log(server + 'albi.php?tipe_wisata=' + tipe);
            hapus_kecuali_landmark();
            hapus_landmark();
            hapus_menu();
            hapus_Semua();
            ...
            $('#kanan_table').append("<tr><th class='centered'>Destination</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'albi.php?tipe_wisata=' + tipe,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    if (rows == null) {
                    ...
                    for (var i in rows) {
                        ...
                        var color = row.color;
                        var route_color = row.route_color;
                        $('#kanan_table').append("<tr><td>" + destination + "</td><td><a role='button' class='btn btn-default fa fa-info' onclick='data_angkot_1_info(\"" + id + "\")'>&nbsp&nbsp&nbspInfo</a><a role='button' class='btn btn-default fa fa-info' onclick='tampil_tourism(\"" + id + "\")'>&nbsp&nbsp&nbspTampil</a><a style='margin-left:10px' role='button' class='btn btn-default fa fa-bus' onclick='data_angkot_1_rute(\"" + id + "\")'>Route</a></td></tr>");
        ...
        function tampil_hotel(id_angkot) { // HOTEL SEKITAR ANGKOT
            var tipe = $('#tipe').val();
            var sasa = $('#sasa').val();

            console.log(id_angkot);
            console.log(server + 'tampil_fungsi_rizi.php?id_angkot=' + id_angkot + '&tipe_kuliner=' + tipe + '&capacity=' + kapasitas);
            $('#view_table_sekitar').show();
            $('#table_kanan_hotel').empty();
            $('#table_hotel').append("<tr><th class='centered'>Hotel Name</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'tampil_fungsi_rizi.php?id_angkot=' + id_angkot + '&tipe_hotel=' + tipe + '&marriage_book=' + sasa,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
        ...
        function tampil_culiner(id_angkot) { // HOTEL SEKITAR ANGKOT
            var tipe = $('#tipe_kuliner').val();
            var kapasitas = $('#capacity').val();

            console.log(id_angkot);
            console.log(server + 'tampil_fungsi_viki.php?id_angkot=' + id_angkot + '&tipe_kuliner=' + tipe + '&capacity=' + kapasitas);
            $('#view_table_sekitar').show();
            $('#table_kanan_culinary').empty();
            $('#table_culinary').append("<tr><th class='centered'>Culinary Name</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'tampil_fungsi_viki.php?id_angkot=' + id_angkot + '&tipe_kuliner=' + tipe + '&capacity=' + kapasitas,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
        ...
        function tampil_souvenir(id_angkot) { // HOTEL SEKITAR ANGKOT
            var tipe = $('#tipe_souvenir').val();

            console.log(id_angkot);
            console.log(server + 'tampil_fungsi_eci.php?id_angkot=' + id_angkot + '&tipe_souvenir=' + tipe);
            $('#view_table_sekitar').show();
            $('#table_kanan_souvenir').empty();
            $('#table_souvenir').append("<tr><th class='centered'>Souvenir Name</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'tampil_fungsi_eci.php?id_angkot=' + id_angkot + '&tipe_souvenir=' + tipe,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
        ...
        function tampil_worship(id_angkot) { // HOTEL SEKITAR ANGKOT
            var tipe = $('#tipe_mesjid').val();
            var kapasitas = $('#kapasitas').val();

            console.log(id_angkot);
            console.log(server + 'tampil_fungsi_ica.php?id_angkot=' + id_angkot + '&tipe_mesjid=' + tipe + '&kapasitas=' + kapasitas);
            $('#view_table_sekitar').show();
            $('#table_kanan_souvenir').empty();
            $('#table_souvenir').append("<tr><th class='centered'>Worship Name</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'tampil_fungsi_ica.php?id_angkot=' + id_angkot + '&tipe_mesjid=' + tipe + '&kapasitas=' + kapasitas,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
                        ...
                        markersDua.push(marker);
                        map.setCenter(centerBaru);
                        $('#table_kanan_worship').append("<tr><td>" + name + "</td><td><a role='button' class='btn btn-default fa fa-info' style='margin-right:10px' onclick='modal_mesjid(\"" + id + "\")'></a><a role='button' class='btn btn-default fa fa-picture-o' style='margin-right:10px' onclick='galeri(\"" + id + "\")'></a><a role='button' class='btn btn-default fa fa-bus' onclick='route_angkot(\"" + lat2 + "\",\"" + lng2 + "\",\"" + lat + "\",\"" + lng + "\",\"" + id_angkot + "\",\"" + id + "\")'>Route</a></td></tr>");
                    } //end for
                }
            }); //end ajax  
        }

        function tampil_tourism(id_angkot) { // HOTEL SEKITAR ANGKOT
            var tipe = $('#tipe_wisata').val();

            console.log(id_angkot);
            console.log(server + 'tampil_fungsi_albi.php?id_angkot=' + id_angkot + '&tipe_wisata=' + tipe);
            $('#view_table_sekitar').show();
            $('#table_kanan_tourism').empty();
            $('#table_tourism').append("<tr><th class='centered'>Tourism Name</th><th class='centered'>Action</th></tr>");
            $.ajax({
                url: server + 'tampil_fungsi_albi.php?id_angkot=' + id_angkot + '&tipe_wisata=' + tipe,
                data: "",
                dataType: 'json',
                success: function(rows) {
                    for (var i in rows) {
